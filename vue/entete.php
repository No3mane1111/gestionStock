...
@include './loginwebdesigner/config.php';
  ...
  <body>
    ...
    <span class="logo_name"></span>
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="commandeTest.php">
            <i class="bx bx-coin-stack"></i>
            <span class="links_name">Test Commande</span>
          </a>
        </li>
    ...
    <div class="search-box">
        <input type="text" name="search" placeholder="Recherche..." value="<?= isset($_GET['search']) ? htmlspecialchars($_GET['search']) : '' ?>" class="search-input">
