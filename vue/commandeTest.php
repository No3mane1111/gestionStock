...
if(!empty($_GET['idArt'])){
    $article = getCommande2($_GET['idArt']);
}
?>
<div class="home-content">
    <div class="overview-boxes">
        <div class="box">
            <form action="<?= !empty($_GET['ticketCom']) ? '../model/modifierCom.php' : '../model/ajouterCom.php' ?>" method="post">
                <input value="<?= !empty($_GET['ticketCom']) ? $article['idArt'] : '' ?>" type="hidden" name="idArt" id="idArt">

                <label for="ticketCom">Ticket Commande</label>
                <input value="" type="number" name="ticketCom" id="ticketCom">
                <br><br>    
                ...
                <input onkeyup="setPrixCom()" value="<?= !empty($_GET['ticketCom']) ? $article['quantiteCom'] : '' ?>" type="number" name="qtCom" id="qtCom">
                <br><br>
            ...
            <table class="mmtable">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="factureTest.php?ticketCom=<?= $value['ticketCom'] ?>"><i class='bx bx-receipt'></i></a>
                            <a onclick="annulerCommande(<?= $value['ticketCom'] ?>, <?= $value['idArt'] ?>, <?= $value['quantiteCom'] ?>)" style="color: red;"><i class='bx bx-stop-circle'></i></a>
                        </td>
                    </tr>
                <?php
                    }
