...
try {
    if (!empty($_POST['ticketCom']) &&
        ...
        // Insert the commande
        $sql = "INSERT INTO commandetest (ticketCom,idArt, idFour, prixCom, quantiteCom, dateEntre,prixUnitCom) VALUES (?,?, ?, ?, ?,?,?)";
...
header('Location: ../vue/commandetest.php');
exit();
?>
